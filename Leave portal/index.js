...
const users = {
    'employee@company.com': { password: 'emp123', role: 'employee', name: 'Hashma', type: 'full-time' },
    'intern@company.com': { password: 'int123', role: 'employee', name: 'Sai Bhargavi', type: 'intern' },
    'trainee@company.com': { password: 'trn123', role: 'employee', name: 'Sushmitha', type: 'trainee' },
    'manager@company.com': { password: 'mgr123', role: 'manager', name: 'Madhumitha', type: 'full-time' },
    'admin@company.com': { password: 'admin123', role: 'admin', name: 'Admin', type: 'full-time' }
};
